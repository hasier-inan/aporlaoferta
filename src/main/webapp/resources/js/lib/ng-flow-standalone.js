    ...
    FlowChunk.prototype = {
        ...
        getParams: function () {
            return {
                ...
                _csrf: this.flowObj.defaults.rqManTok
            };
        },
        ...
        prepareXhrRequest: function (method, isTest, paramsMethod, blob) {
            ...
            this.xhr.setRequestHeader('X-CSRF-TOKEN', this.flowObj.defaults.rqManTok);
            return data;
        }
    };
...
angular.module('flow.init', ['flow.provider'])
    .controller('flowCtrl', ['$scope', '$attrs', '$parse', 'flowFactory', 'requestManager',
        function ($scope, $attrs, $parse, flowFactory, requestManager) {
            ...
            flow.defaults.rqManTok=requestManager.getActualToken();
