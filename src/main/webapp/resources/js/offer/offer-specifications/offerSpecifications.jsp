            ...
            <sec:authorize ifAllGranted="ROLE_USER">
                ...
                <div class="offer-specifications edit-offer expire-offer"
                    ...
                    <button ng-disabled="offer.offerExpired"
                            class="button small icon fa-trash whiteButton red-background" ng-click="expireOffer(offer)">
                        Oferta Caducada
                    </button>
                    <button ng-disabled="offer.offerExpired"
                            class="button mini icon fa-trash whiteButton red-background" ng-click="expireOffer(offer)">
                    </button>
                </div>
            </sec:authorize>
