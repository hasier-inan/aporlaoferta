 ...
 */
public class InvalidUploadFolderException extends RuntimeException {
     ...
     */
    public InvalidUploadFolderException(String key) {
        this(false, key);
    }
     ...
     */
    public InvalidUploadFolderException(String messageKey, Object... args) {
     ...
     * @param args       - the error value/s e.g. the external loan ID
     */
    public InvalidUploadFolderException(boolean inline, String messageKey, Object... args) {
        super(messageKey);
